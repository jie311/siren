...
class QueryGenerator(object):
    def __init__(self, base_model,adaptor):
        ...
        self.adaptor_path_dict={
            ...
            "mistral": {"decop_1": "path-to-/LLaMA-Factory/saves/mistral_sft_dpo/train_decop_1",
            ...
            "qwen": {"decop_1": "path-to-/LLaMA-Factory/saves/qwen_sft_dpo/train_decop_1",
        ...
        self.adaptor_path=self.adaptor_path_dict[base_model][adaptor]
    ...
    def load_model_adapter(self):
        ...
        model_tmp = AutoModelForCausalLM.from_pretrained(
            self.base_model_dict[self.base_model][self.adaptor],
            return_dict=True,
            torch_dtype=torch.float16,
        )
        tokenizer = AutoTokenizer.from_pretrained(self.base_model_dict[self.base_model][self.adaptor])
