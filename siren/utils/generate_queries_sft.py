...
class QueryGenerator(object):
    def __init__(self, base_model,adaptor):
        ...
        self.adaptor_path_dict={
            "llama3":{"decop_1": "path-to-/saves/llama3_sft/train_decop_1",
                      "decop_2": "path-to-/saves/llama3_sft/train_decop_2",
                      "combined":"path-to-/saves/llama3_sft/train_combined"},
            "mistral": {"decop_1": "path-to-/saves/mistral_sft/train_decop_1",
                       "decop_2": "path-to-/saves/mistral_sft/train_decop_2",
                       "combined": "path-to-/saves/mistral_sft/train_combined"},
            "qwen": {"decop_1": "path-to-/saves/qwen_sft/train_decop_1",
                        "decop_2": "path-to-/saves/qwen_sft/train_decop_2",
                        "combined": "path-to-/saves/qwen_sft/train_combined"}
        }
